...
class Habits:
    ...
    def __init__(self, master, username):
       ...
       # Define grid 3 x 21
        ...
        self.date_label.grid(row=0, column=4, rowspan=2, columnspan=3,sticky='e')
        self.signout_button.grid(row=0, column=7, rowspan=2, sticky='e')
        ...
        self.habit_center_label.grid(
            row=0, column=0, columnspan=10, sticky='nesw', pady=(0, 10))
        ...
        #    row=0, column=10, columnspan=11, sticky='nesw')
        ...
        # Geometrtic Distribution
        # *PANEL 2
        self.manage_habit_button.pack()
        self.add_habit_button.pack()
        self.w_stats_button.pack()
        ...
        #self.name_label.grid(row=1, column=0, rowspan=2,
        #                     columnspan=3, sticky='w', padx=10, pady=3)
        #self.entry_name.grid(row=3, column=0, rowspan=2,
        #                     columnspan=15, sticky='nesw', padx=10, pady=3)
        #self.repetition_label.grid(
        #    row=5, column=0, rowspan=2, columnspan=3, sticky='w', padx=10, pady=3)
        #self.spinbox_repetition.grid(
        #    row=5, column=3, rowspan=2, columnspan=4, sticky='news', padx=10, pady=3)
        #self.monday_radiobutton.grid(
        #    row=9, column=0, rowspan=1, columnspan=2, sticky='e')
        #self.tuesday_radiobutton.grid(
        #    row=9, column=2, rowspan=1, columnspan=2, sticky='w')
        #self.wednesday_radiobutton.grid(
        #    row=9, column=4, rowspan=1, columnspan=2, sticky='w')
        #self.thursday_radiobutton.grid(
        #    row=9, column=6, rowspan=1, columnspan=2, sticky='w')
        #self.friday_radiobutton.grid(
        #    row=9, column=8, rowspan=1, columnspan=2, sticky='w')
        #self.saturday_radiobutton.grid(
        #    row=9, column=10, rowspan=1, columnspan=2, sticky='w')
        #self.sunday_radiobutton.grid(row=9, column=13, rowspan=1, columnspan=2)

        #self.morning_button.grid(row=11, column=4, rowspan=4, columnspan=3)
        #self.afternoon_button.grid(row=11, column=7, rowspan=4, columnspan=3)
        #self.evening_button.grid(row=11, column=10, rowspan=4, columnspan=3)
        #self.all_day_button.grid(row=11, column=13, rowspan=4, columnspan=3)

        #self.add_habit_button.grid(
        #    row=12, column=0, rowspan=3, columnspan=3, sticky='nesw')
    ...
    def add_window(self, root2):
        ...
        # Entry for Habit Name
        self.entry_name = ttk.Entry(
            self.root2, width=20, font=('Arial', 10))
